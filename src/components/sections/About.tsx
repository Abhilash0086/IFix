    ...
    <section id="about" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-3 mb-4">About iFix Bluetooth</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-gray-900 font-semibold text-lg">Our Vision</h3>
              </div>
              <p className="text-gray-500">
                To be India&apos;s most trusted and accessible Bluetooth device repair center —
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-gray-900 font-semibold text-lg">Our Mission</h3>
              </div>
              <p className="text-gray-500">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm space-y-4">
              <h3 className="text-gray-900 font-semibold text-lg mb-1">Visit Us</h3>
              ...
              <div className="flex gap-3 text-gray-500">
                ...
                <a href={BUSINESS.instagramUrl} target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">
                  {BUSINESS.instagram}
                </a>
              </div>
            </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="rounded-2xl overflow-hidden h-96 lg:h-auto border border-gray-200 shadow-sm"
          >
            <iframe
